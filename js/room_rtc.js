const APP_ID = "1bb10bce1612401299effec04b70f31d";
...
//     await rtmClient.rtmClient.addOrUpdateLocalUserAttributes({'name': displayName})

//     channel = await rtmClient.createChannel(roomId);  // Fixed typo: createChannel
//     await channel.join();
